...
class DecisionTransformer(TrajectoryModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        print(rtg_dim, concat_rtg_pref, pref_dim)
        print(act_dim, concat_act_pref, pref_dim)
    ...
    def forward(self, states, actions, returns_to_go, pref, timesteps, attention_mask=None, ret_embeddings=False):
    ...
    def get_embeddings(self, states, actions, returns_to_go, pref, timesteps, **kwargs):
        ...
        embeddings = self.forward(
            states, actions, returns_to_go, pref, timesteps, attention_mask=attention_mask, ret_embeddings=True)
